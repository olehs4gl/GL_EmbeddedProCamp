...
void StartDefaultTask(void const * argument)
{
  ...
  for(;;)
  {
		if((char)((short)( TIM3 -> CNT  + 2000 ) / 18000) != on_off)
		{
			on_off = (char)((short)( TIM3 -> CNT  + 2000 ) / 18000 );
			if(on_off)
			{
...
void StartTask02(void const * argument)
{
  ...
  for(;;)
  {
		if((char)((short)( TIM3 -> CNT ) / 10000 ) != on_off)
//		if(((TIM3 -> CR1) & 0x00000001) == 0)
		{
//			TIM3 -> CR1 |= 0x00000001;
			on_off = (char)((short)( TIM3 -> CNT ) / 10000 );
			if(on_off)
			{
...
void StartTask03(void const * argument)
{
  ...
  for(;;)
  {
		if((char)((short)( TIM3 -> CNT  + 2000 ) / 12000) != on_off)
		{
			on_off = (char)((short)( TIM3 -> CNT  + 2000 ) / 12000 );
			if(on_off)
			{
